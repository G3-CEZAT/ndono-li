...
export default function App() {
  ...
  const handleSubmitDecision = (
    ...
    const actionLabels: Record<ValidationStatus, string> = {
      certified: 'Réponse certifiée avec succès et transmise au serveur mobile.',
      corrected: 'Correction enregistrée et validée pour diffusion mobile.',
  ...
  return (
    <div className="flex h-screen bg-[#F4F6F5] text-[#1A1A1A] font-sans overflow-hidden">
      {/* Imposed Sidebar with Zawiya Visual Identity */}
      <Sidebar
        activeTab={activeTab}
